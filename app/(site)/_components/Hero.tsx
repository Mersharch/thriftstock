    ...
    <div className="flex-1">
      <div className="relative flex flex-1 h-screen lg:h-[100vh] bg-[url('../public/images/bg.jpg')] bg-cover bg-no-repeat bg-center">
        ...
        <div className="w-full z-10 flex-1">
          <NavBar />
          <div className="flex flex-col text-white h-full items-center justify-end pb-96 md:pb-64 self-center">
            <div className="max-w-fit flex flex-col">
              <motion.h1
                ...
                className="font-brittany text-6xl sm:text-4xl md:text-9xl"
              >
                Event Studios
              </motion.h1>
              <motion.p
